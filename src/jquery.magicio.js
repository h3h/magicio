...
(function() {
  ...
  (function($) {
    var Action, UNIQUE_STR, actionTypeFromEl, inputEvent, log, methods, settings, _ref, _ref1;
    ...
    inputEvent = ($ != null ? (_ref = $.mobile) != null ? (_ref1 = _ref.support) != null ? _ref1.touch : void 0 : void 0 : void 0) ? 'vclick' : 'click';
    Action = (function() {
    ...
    methods = {
      ...
      runAction: function(jqEl, actions, ix) {
        var action, data, inputCallback, ixNext, prevAction;
        ...
        switch (action.eventType()) {
          ...
          case 'input':
            inputCallback = function(evt) {
              ...
              if (evt.which === 32 && settings.disableScrollOnSpace) {
                evt.preventDefault();
              }
              if (inputEvent === "vclick") {
                evt.preventDefault();
            ...
            if (!((data = jqEl.data('magicio')) && data['input_callback'])) {
              jqEl.data('magicio', {
